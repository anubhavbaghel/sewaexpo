            ...
            <nav class="bg-white/95 backdrop-blur-md border-b border-gray-200 shadow-sm">
                <div class="max-w-7xl mx-auto px-4 md:px-8 py-4 flex items-center justify-between"><a
                    ...
                    <div class="hidden md:flex gap-3"><a href="<?= $root ?>registration/"><button
                                class="border-2 border-[#1A4D3E] text-[#1A4D3E] px-6 py-2.5 rounded-lg text-sm font-sans font-medium tracking-wide hover:bg-[#1A4D3E] hover:text-white transition-colors duration-300 cursor-pointer">Register</button></a><a href="<?= $root ?>assets/testing.pdf" download><button
